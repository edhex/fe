(function(){
  ...
  const valueData={
    ...
    unfiltered:{kicker:'The turning points',title:'What changed when their first approach stopped working.',copy:'The useful lessons are often the adjustments: the routine they dropped, the advice they finally listened to, the moment they changed how they revised, or the way they reset after pressure built. FutureEdge surfaces those turning points so students can adapt earlier.'},
  ...
  const questionData={
    assessment:{title:'After a bad assessment, the best students usually reset fast.',note:'Not a polished story — the actual moves: what they changed next, what they stopped doing and how they got perspective back.',examples:[['Diagnose the real issue','Was it knowledge, timing, exam technique, stress or overconfidence?'],['Change something immediately','High performers usually changed the system, not just promised to “work harder”.'],['Recover perspective quickly','One bad result became feedback, not an identity crisis.']]},
